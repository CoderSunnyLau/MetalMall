...
<div class="cnt_body">
	<p class="order_top">
		<span>订单编号：</span><i class="os_id">10258665220</i>
		<span>订单状态：</span><i class="os_status"></i>
	</p>
	<div>
		<div class="order_detail_block">
			...
			<div class="order_account">
				<p><span>商品总价：</span><i class="red">￥<big class="os_amount"></big></i></p>
				<p><span>服务费：</span><i class="red">￥<big class="os_serviceCharge"></big></i></p>
				<p><span>订单总额：</span><i class="red order_total_style">￥<big class="order_total"></big></i></p>
			</div>
		</div>
		<div class="order_block track_block">
			<p class="user_title">订单跟踪</p>
			<div class="order_track order_row">
				<p><span>已发货</span><span>xxx确认发货</span><span>小A</span><span>2017-08-30</span></p>
				<p class="odd"><span>已发货</span><span>xxx确认发货</span><span>小A</span><span>2017-08-30</span></p>
				<p><span>已发货</span><span>xxx确认发货</span><span>小A</span><span>2017-08-30</span></p>
				<p class="odd"><span>已发货</span><span>xxx确认发货</span><span>小A</span><span>2017-08-30</span></p>
			</div>
		</div>
