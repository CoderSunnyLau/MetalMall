...
<div class="cnt_body c">
	<div class="cnt_top">
		<div class="user_info">
			<div class="avatar"><img src="../images/default_user.png" /></div>
			<p class="user_row">用户名称：<i class="user_id">--</i></p>
			<p class="user_row">用户姓名：<i class="real_name">--</i></p>
		</div>
	...
	<div class="cnt_bottom">
		<div class="cnt_row">
			...
			<p class="row_set"><a jump="account_pwd">修改</a></p>
		</div>
		<!-- <div class="cnt_row">
...
<script>
	sysInit();
	$('.cnt_body').show();
	cntLoad($('[jump="account_pwd"]'), 'company');
	var successCallback = function(){
		$('.user_id').html(USER.loginName);
		$('.real_name').html(USER.optsName);
	}
</script>